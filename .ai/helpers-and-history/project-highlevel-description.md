...
- Each word contains definitions in the target language, the user’s translation, and an example of usage in the target language
- AI can generate words and example sentences based on the selected category and difficulty level
- Users can browse words in a category in a full table or switch to a word-sliding (flashcard) mode
