...
export async function GET(request: NextRequest) {
  try {
    ...
    const result: LearningLanguagesListDto =
      await LearningLanguageService.getLearningLanguages(userId, validatedQuery)
...
export async function POST(request: NextRequest) {
  try {
    ...
    const result: LearningLanguageDto =
      await LearningLanguageService.createLearningLanguage(
        userId,
        validatedCommand
      )
