...
import { categoryParamsSchema, generateWordsCommandSchema } from '@/lib/validation'
...
export async function POST(
  ...
  try {
    ...
    const learningLanguageCodeFromProfile = (learningRow as { language_id?: string } | null)
      ?.language_id
    ...
    const result: AiGeneratedWordsDto = await AiGenerationService.generateWords({
      ...validatedCommand,
